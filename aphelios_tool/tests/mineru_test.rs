...
// use aphelios_tool::commands::minersu::{self, preprocess_to_image};
...
//         let i1 = core_utils::crop_image(&image2, [item.x1, item.x2, item.y1, item.y2], 5);
...
//     let image2 = preprocess_to_image(image);
//     let i1 = core_utils::crop_image(&image2, [152, 113, 862, 132], 5);
