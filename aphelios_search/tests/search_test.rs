...
#[test]
fn hybrid_search_advanced_test() -> Result<()> {
    let mut se = SearchEngine::new()?;
    ...
    // ========== 测试1 ==========
    println!("\n搜索关键词: '苏联'");
    let results = se.hybrid_search("苏联", 10)?;
    for (name, score, label) in &results {
        println!("[{}] {} (得分: {:.4})", label, name, score);
    }
    ...
    // ========== 测试2 ==========
    println!("\n搜索关键词: 'USSR'");
    let results = se.hybrid_search("USSR", 10)?;
    for (name, score, label) in &results {
        println!("[{}] {} (得分: {:.4})", label, name, score);
    }
    ...
    // ========== 测试3 ==========
    println!("\n搜索关键词: '俄罗斯'");
    let results = se.hybrid_search("俄罗斯", 10)?;
    for (name, score, label) in &results {
        println!("[{}] {} (得分: {:.4})", label, name, score);
    }
    ...
    // ========== 测试4 ==========
    println!("\n搜索关键词: '列宁'");
    let results = se.hybrid_search("列宁", 10)?;
    for (name, score, label) in &results {
        println!("[{}] {} (得分: {:.4})", label, name, score);
    }
