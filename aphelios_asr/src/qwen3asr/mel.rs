...
pub fn load_audio_wav(path: &str, target_sr: u32) -> crate::qwen3asr::Result<Vec<f32>> {
    load_audio_wav_impl(path, target_sr).map_err(crate::qwen3asr::error::AsrError::AudioDecode)
}
